...
public final class Native {
    static { System.loadLibrary("octoscript_catalog"); }
     ...
     * tree. No Octoscript DSL is involved on this path.
     *
     * The same plan JSON is lowered by octos-one to makepad Octoscript DSL, so this is
